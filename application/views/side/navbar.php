<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="danger" data-background-color="white" data-image="<?php echo base_url()?>master/assets/img/logo.png">
      <div class="logo">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a style="font-size: 28px; padding-left: 10px; " class="navbar-brand" href="<?php echo base_url() ?>">TELKOM WITEL YOGYAKARTA</a>
          </div>
