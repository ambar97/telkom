...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url()?>master/assets/img/telkom.jpg">
  ...
  <!-- CSS Files -->
  <link href="<?php echo base_url()?>master/assets/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
